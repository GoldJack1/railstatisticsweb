...
|------------|------|--------|
| `stations_gbnr`, `stations_nitranslink`, `stations_roiirerail`, `stations_gbheritage`, `lightrail_GBSHEFFSUPERTRAM`, `newsandboxstations1` | **Anyone** (including signed-out clients) | **Station editors only** |
