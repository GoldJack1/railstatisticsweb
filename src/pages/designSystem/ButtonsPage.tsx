...
${VARIANT_TOKENS.map((token) => {
  return [
    `${token.label}`,
    `- Active`,
    `  - Light bg: ${token.active.light.bg.hsl} / ${token.active.light.bg.hex}`,
    `  - Light text: ${token.active.light.text.hsl} / ${token.active.light.text.hex}`,
    `  - Dark bg: ${token.active.dark.bg.hsl} / ${token.active.dark.bg.hex}`,
    `  - Dark text: ${token.active.dark.text.hsl} / ${token.active.dark.text.hex}`,
    `- Pressed`,
    `  - Light bg: ${token.pressed.light.bg.hsl} / ${token.pressed.light.bg.hex}`,
    `  - Light text: ${token.pressed.light.text.hsl} / ${token.pressed.light.text.hex}`,
    `  - Dark bg: ${token.pressed.dark.bg.hsl} / ${token.pressed.dark.bg.hex}`,
    `  - Dark text: ${token.pressed.dark.text.hsl} / ${token.pressed.dark.text.hex}`,
    `- Disabled`,
    `  - Light bg: ${token.disabled.light.bg.hsl} / ${token.disabled.light.bg.hex}`,
    `  - Light text: ${token.disabled.light.text.hsl} / ${token.disabled.light.text.hex}`,
    `  - Dark bg: ${token.disabled.dark.bg.hsl} / ${token.disabled.dark.bg.hex}`,
    `  - Dark text: ${token.disabled.dark.text.hsl} / ${token.disabled.dark.text.hex}`,
  ].join('\n')
}).join('\n\n')}`
    ...
    <div className="container">
      <div className="ds-buttons">
        ...
        <section className="ds-buttons__section">
          ...
          <p>Each state shows the button plus light/dark HSL and HEX values for background and text.</p>
                ...
                <div className="ds-buttons__state-detail-grid">
                  <div className="ds-buttons__state-detail">
                    ...
                    <div className="ds-buttons__value-block">
                      <div><strong>Light bg</strong> {token.active.light.bg.hsl} / {token.active.light.bg.hex}</div>
                      <div><strong>Light text</strong> {token.active.light.text.hsl} / {token.active.light.text.hex}</div>
                      <div><strong>Dark bg</strong> {token.active.dark.bg.hsl} / {token.active.dark.bg.hex}</div>
                      <div><strong>Dark text</strong> {token.active.dark.text.hsl} / {token.active.dark.text.hex}</div>
                    </div>
                  </div>
                  <div className="ds-buttons__state-detail">
                    ...
                    <div className="ds-buttons__value-block">
                      <div><strong>Light bg</strong> {token.pressed.light.bg.hsl} / {token.pressed.light.bg.hex}</div>
                      <div><strong>Light text</strong> {token.pressed.light.text.hsl} / {token.pressed.light.text.hex}</div>
                      <div><strong>Dark bg</strong> {token.pressed.dark.bg.hsl} / {token.pressed.dark.bg.hex}</div>
                      <div><strong>Dark text</strong> {token.pressed.dark.text.hsl} / {token.pressed.dark.text.hex}</div>
                    </div>
                  </div>
                  <div className="ds-buttons__state-detail">
                    ...
                    <div className="ds-buttons__value-block">
                      <div><strong>Light bg</strong> {token.disabled.light.bg.hsl} / {token.disabled.light.bg.hex}</div>
                      <div><strong>Light text</strong> {token.disabled.light.text.hsl} / {token.disabled.light.text.hex}</div>
                      <div><strong>Dark bg</strong> {token.disabled.dark.bg.hsl} / {token.disabled.dark.bg.hex}</div>
                      <div><strong>Dark text</strong> {token.disabled.dark.text.hsl} / {token.disabled.dark.text.hex}</div>
                    </div>
                  </div>
                </div>
              </article>
